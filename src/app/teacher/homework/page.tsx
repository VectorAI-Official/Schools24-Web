  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-3xl font-bold text-green-500">{totalSubmissions}</p>
      ...
      <div className="space-y-4">
        {listQuery.isLoading ? (
          <Card>
            <CardContent className="p-6 text-center text-muted-foreground">Loading homework...</CardContent>
          </Card>
        ) : homeworks.length === 0 ? (
          <Card>
            <CardContent className="p-6 text-center text-muted-foreground">No homework assigned yet.</CardContent>
          </Card>
        ) : (
