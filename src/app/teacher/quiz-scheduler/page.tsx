      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardContent className="p-4 md:p-6 text-center">
            <p className="text-xl md:text-3xl font-bold text-primary">{stats.upcoming}</p>
        ...
        <Card>
          <CardContent className="p-4 md:p-6 text-center">
            <p className="text-xl md:text-3xl font-bold text-blue-500">{stats.completed}</p>
            <p className="text-sm text-muted-foreground">Completed</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 md:p-6 text-center">
            <p className="text-xl md:text-3xl font-bold text-purple-500">{stats.total}</p>
      ...
      <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {quizzesQuery.isLoading ? (
          <Card className="md:col-span-2 lg:col-span-3">
            <CardContent className="p-4 md:p-8 text-center text-muted-foreground">Loading quizzes...</CardContent>
          </Card>
        ) : quizzes.length === 0 ? (
          <Card className="md:col-span-2 lg:col-span-3">
            <CardContent className="p-4 md:p-8 text-center text-muted-foreground">No quizzes found.</CardContent>
          </Card>
        ) : (
          quizzes.map((quiz) => (
