import {
    ...
    Material, Message, UserRole, Homework
} from '@/types';

// Re-export types for backward compatibility
export type { User, Student, Teacher, Staff, Event, Quiz, BusRoute, InventoryItem, TimetableSlot, AttendanceRecord, FeeRecord, Material, Message, UserRole, Homework };
